...
<div class="main-container <?php print $container_class; ?>">
  ...
  <div class="row">
    ...
    <?php if (!empty($page['primary_first']) || !empty($page['sidebar_first'])): ?>
    ...
    <?php if (!empty($page['sidebar_second'])): ?>
      <aside class="col-sm-12 col-md-3 col-xs-12" role="complementary">
...
<footer class="footer">
  <div class="footer-first col-sm-3 col-xs-12">
    <?php print render($page['footer_first']); ?>
  </div>
  <div class="footer-second col-sm-6 col-xs-12">
    <?php print render($page['footer_second']); ?>
  </div>
  <div class="footer-thrid col-sm-3 col-xs-12">
